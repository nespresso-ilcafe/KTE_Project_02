...
@WebServlet("/admin/banner/bannerwrite")
public class BannerWrite extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dis = request.getRequestDispatcher("/admin/banner/bannerwrite.jsp");
