...
<center>
   <table width=800>
      ...
      <tr>
         <td style="font-weight: bold;font-size:20px">이용약관</td>
      </tr>
      <tr>
         <td height=10></td>
      </tr>
      <tr>
         <td>
         <br><br>제1조(목적) 이 약관은 "야입규문" 회사(전자상거래 사업자)가 운영하는 "야입규문" 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
<br>
...
제2조(정의)
 ...
 <br>
  ...
  ① “몰”이란 "야입규문" 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
<br>
