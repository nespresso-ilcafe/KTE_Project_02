        ...
        <tr>
            <c:choose>
                <c:when test="${cate1 != null && cate1 != '' }">
                    <td align="center" colspan="5" id="itemall">
                        <a href="list?category1=${cate1}" style="color:white;font-size:20px;">전체상품보기</a>
                    </td>
                </c:when>
                <c:otherwise>
                    <td align="center" colspan="5" id="itemall">
                        <a href="mainsearch?search=${search }" style="color:white;font-size:20px;">전체상품보기</a>
                    </td>
                </c:otherwise>
            </c:choose>
        </tr>
                    ...
                    <c:forEach var="i" begin="${startPage }" end="${endPage }">
                        <c:choose>
                            <c:when test="${pageNum == i }">
                                <c:choose>
                                    <c:when test="${cate2 !='' && cate2 != null}">
                                        <a href="list2?category1=${cate1}&category2=${cate2}&pageNum=${i}&field=${field}&search=${search}">
                                            <font style="color:black;font-size:18px;font-weight:bold;">${i }</font>
                                        </a>
                                    </c:when>
                                    <c:when test="${cate1 !='' && cate1 != null}">
                                        <a href="list?category1=${cate1}&pageNum=${i}&field=${field}&search=${search}">
                                            <font style="color:black;font-size:18px;font-weight:bold;">${i }</font>
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="mainsearch?pageNum=${i}&search=${search}">
                                            <font style="color:black;font-size:18px;font-weight:bold;">${i }</font>
                                        </a>
                                    </c:otherwise>
                                </c:choose>
