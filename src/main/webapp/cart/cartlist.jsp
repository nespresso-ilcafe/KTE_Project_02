...
<center>
    ...
    <br>
        <table width=1000 bgcolor="black">
        	<tr>
        		<td style="color:white;font-size:18px;" colspan="2" height="40" align="center">장바구니
        		</td>
        	</tr>
            <tr>
            	<td width="5"></td>
                <td style="color:white" height="40" align="left">total : ${count }</td>
                <input type="hidden" id="tcount" value="${count }">
            </tr>
		</table>
		<br>
		<table width=1000 height="40" bgcolor="black">
            <tr>
                <td align="center" width="50"><input type="checkbox" id="checkAll" checked></td>
                <td align="center" style="color:white;">상품정보</td>
            	<td width="50"></td>
            </tr>
            </table>
            <table width=1000>
            ...
            <tr class="row">
                ...
                <td align="center" width="75">
                    ...
                    <c:choose>
                        <c:when test="${v.it_sale ne 0}">
                            ...
                            <span style="color:orange;font-weight:bold;font-size:18px;">할인가 : <fmt:formatNumber value="${v.it_sale }" type="number"/> 원</span><br>
                        </c:when>
                        <c:otherwise>
                            <span style="color:black;font-weight:bold;font-size:18px;">정상가 : <fmt:formatNumber value="${v.it_price }" type="number"/></span><br>
                        </c:otherwise>
                    </c:choose>
                 </td>
                 <td align="center">
                ...
                <td align="center" width="50">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <input id="qty" name="it_qty" value="${v.it_qty }" style="width:20px;height:20px;border:none;font-size:18px;text-align:center" readonly>개
                        </c:otherwise>
                    </c:choose>
                </td>
         ...
         <table width="1000" height="80" bgcolor="black">
            <tr>
            	<td width="200"></td>
                <td colspan="6" rowspan="3" align="center">
                    <button onclick="a()" id="button">
                    주문하기</button>
                </td>
            	<td width="200" align="right" style="color:white">상품 금액 : <span id="pay_total"></span></td>
            </tr>
            <tr>
            	<td onclick="onedelete()" id="delete">선택상품 삭제</td>
            	<td align="right" style="color:white">배송비 : <span id="sendPay"></span></td>
            </tr>
            <tr>
            	<td></td>
            	<td align="right" style="color:white">총 결제 금액 : <span id="lastTotalPrice"></span></td>
            </tr>
        </table>
    </c:if>
    </form>
    <table width="1000">
        <tr>
            ...
            <td align="right" width="50%">10만원 이상 무료배송</td>
        </tr>
    </table>
    <br>
</center>
